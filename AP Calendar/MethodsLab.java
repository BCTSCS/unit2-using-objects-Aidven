...
public class MethodsLab {
    ...
    public static void valueVsNew(){
        ...
        Integer new1 = new Integer(100);
        Integer new2 = new Integer(100);
        System.out.println("valueOf() " + (num1==num2));
        System.out.println("new Integer() " + (new1==new2));
        System.out.println("valueOf() and new Integer() " + (num1==new1));
     }
    ...
    public static void exercises() {
        ...
        System.out.println("Vowel count in " + testStr + " is: " + countVowels(testStr));
    }
